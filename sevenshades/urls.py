...
from sevenshadesapp import userinterface, maincategory_views,subcategory_views,brand_views,product_views,banners_views,productdetail_views,admin_login_views
